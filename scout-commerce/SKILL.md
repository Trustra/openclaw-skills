...
name: scout-commerce
version: 1.0.0
description: Search for products on Amazon/shopify and buy with USDC on Solana.
...
Buy from Amazon & Shopify with USDC. US shipping only.
...
**Check Wallet balance** → `python balance.py`
